...
from ..utils import _get_submodules, _get_layer_count
...
class BaseTuner(nn.Module, ABC):
    ...
    def inject_adapter(self, model: nn.Module, adapter_name: str):
        ...
        for key in key_list:
            ...
            layer_total_number = _get_layer_count(model, key)

            optionnal_kwargs = {
                "loaded_in_8bit": getattr(model, "is_loaded_in_8bit", False),
                "loaded_in_4bit": getattr(model, "is_loaded_in_4bit", False),
                "current_key": key,
                "layer_total_number": layer_total_number,
                "lora_linear_dict": lora_linear_dict,
            }
